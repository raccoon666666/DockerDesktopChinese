...
var _defaultGridSlotsComponents = require("./defaultGridSlotsComponents");

Object.keys(_defaultGridSlotsComponents).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _defaultGridSlotsComponents[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _defaultGridSlotsComponents[key];
    }
  });
});
