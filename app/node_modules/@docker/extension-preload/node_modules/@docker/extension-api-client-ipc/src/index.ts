...
import type { v1Hybrid } from '@docker/extension-api-client-types';
...
export function createDockerDesktopClient(
  ...
  return {
    ...
    spawnHostCmd(
      ...
      displayDeprecationWarning(
        'window.ddClient.spawnHostCmd(cmd, ...args, callback)',
        'ddClient.extension.host.cli.spawn(cmd, ...args, callback)',
      );
    ...
    execDockerCmd(cmd: string, ...args: string[]) {
      displayDeprecationWarning(
        'window.ddClient.execDockerCmd(cmd, ...args)',
        'ddClient.docker.exec(cmd, ...args)',
      );
      return ipcRenderer
    ...
    spawnDockerCmd(
      ...
      displayDeprecationWarning(
        'window.ddClient.spawnDockerCmd(cmd, ...args, callback)',
        'ddClient.docker.spawn(cmd, ...args, callback)',
      );
    ...
    toastSuccess(msg) {
      displayDeprecationWarning(
        'window.ddClient.toastSuccess(msg)',
        'ddClient.desktopUI.toast.success(msg)',
      );
      ipcRenderer.invoke(`display-toast-success`, msg);
    },
    toastWarning(msg) {
      displayDeprecationWarning(
        'window.ddClient.toastWarning(msg)',
        'ddClient.desktopUI.toast.warning(msg)',
      );
      ipcRenderer.invoke(`display-toast-warning`, msg);
    },
    toastError(msg) {
      displayDeprecationWarning(
        'window.ddClient.toastError(msg)',
    ...
    listContainers(options) {
      displayDeprecationWarning(
        'window.ddClient.listContainers(options)',
        'ddClient.docker.listContainers(options)',
      );
      return ipcRenderer.invoke(`docker-list-containers`, options);
    },
    listImages(options) {
      displayDeprecationWarning(
        'window.ddClient.listImages(options)',
        'ddClient.docker.listImages(options)',
      );
    ...
    navigateToContainer(id) {
      displayDeprecationWarning(
        ...
        'ddClient.desktopUI.navigate.viewContainer(id)',
      );
    ...
    navigateToContainerInspect(id) {
      displayDeprecationWarning(
        ...
        'ddClient.desktopUI.navigate.viewContainerInspect(id)',
      );
    ...
    navigateToContainerStats(id) {
      displayDeprecationWarning(
        ...
        'ddClient.desktopUI.navigate.viewContainerStats(id)',
      );
    ...
    navigateToVolume(volume) {
      displayDeprecationWarning(
        ...
        'ddClient.desktopUI.navigate.viewVolume(volume)',
      );
